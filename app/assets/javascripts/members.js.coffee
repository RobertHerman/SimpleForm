...
jQuery ->
 ...
 #   console.log($("#member_accepted_eua"))
 #   console.log(@checked)
  ...
  $('.enableOnValidatedData').on("click hover blur", (event) ->
      if Member.validForm()
...
#  $('.enableOnValidatedData').click ->
#    alert("cant do that") unless Member.validForm()
